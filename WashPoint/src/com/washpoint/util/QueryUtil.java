...
public class QueryUtil extends CommonUtil {
	...
	public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
		 ...
		 */
		nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File(System.getProperty("catalina.base") +"\\wtpwebapps\\WashPoint\\WEB-INF\\views\\washpointQurery.xml"))
